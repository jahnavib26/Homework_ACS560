...
//    }
//    
// // New: Get the most selling product for a specific month or all months
//    @GetMapping("/most-selling/{month}")
//    public Sales getMostSellingProductForMonth(@PathVariable int month) {
//        return salesAnalysisService.getMostSellingProductForMonth(month);
//    }
//
//    @GetMapping("/most-selling")
//    public Sales getMostSellingProductForAllMonths() {
//        return salesAnalysisService.getMostSellingProductForAllMonths();
//    }
//}
//
...
public class SalesAnalysisController {
    ...
    // Endpoint to get the most selling product
    @GetMapping("/most-selling")
